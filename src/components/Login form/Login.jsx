...
const {handleSubmit, handleChange, handleBlur, handleReset, values, errors, touched} = useFormik({
    ...
    validationSchema:yup.object({
        ...
        password:yup.string().min(6, 'please provide a password').max(15, 'please enter character between 6 to 15').required('Password is required')
    }),
    onSubmit:(values)=>{
        console.log(values)
    }
    ...
    return (
        <div className='login-form-wrapper'>
           ...
           <label for="uname">Email Address</label><br></br>
            ...
            <Link to= '/Sidebar'><button className='btn' type="submit" class="btn btn-primary">Login Now</button></Link>
